  ...
  return (
    <React.Fragment>
      <Article theme={theme}>
        ...
        <div className="form">
          <p>No fuss. Only new posts. Sign up to never miss an update!</p>
          <form name="subscribe" method="post" onSubmit={handleSubmit} data-netify="true">
            <input
              type="email"
              required
              name="email"
            ...
            />
            <br />
            <input type="submit" value="Subscribe" id="submitButton" className="formItem" />
            ...
            <br />
            <p className="rss">
              Don't want to share email? No worries! <br />
              Follow this blog's feed via{" "}
              <a href={`${siteUrl}` + "/rss.xml"} target="_blank">
                <FaRss /> RSS
              </a>{" "}
            </p>
          </form>
